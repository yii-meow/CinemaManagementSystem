...
class App
{
    private $controller = 'Register';//controller name                           //Can temporarily change to your currently working environment
    ...
    private function splitURL()
    {
        ...
        $URL = $_GET['url'] ?? 'Register';// this must be same with the controller name in line 6                      //Can temporarily change to your currently working environment
