    ...
    <div class="container" id="container">
        ...
        <div class="real-content" id="real">
            <div class="checkmark" style="display: flex; flex-flow: row nowrap; justify-content: center;">
                <img style="width: 60%; margin-bottom: 8px;" src="<?= ROOT ?>/assets/images/checkmark.png"/>
            </div>
            ...
            <div class="submessage">
                ...
                <span style="color: #f03351;" id="lblOrderID">#<?php if(isset($data)){echo $data["ticketId"];} ?></span>.
                <br/>
