                                ...
                                <ul class="nav nav-pills">
                                    ...
                                    <li>
                                        <div class="filter-section mt-3">
                                            ...
                                            <form method="POST" action="<?=ROOT?>/SearchPost/index">
                                                <button class="btn btn-primary btn-sm ml-2" type="submit" style="background-color: #f03351">Apply</button>
                                                <br><br>
                                ...
                                <?php if (!empty($posts)): ?>
                                    <?php foreach ($posts as $post): ?>
                                        <div class="post">
                                            ...
                                            <?php if (!empty($post['contentImg'])): ?>
                                                <img src="<?php echo htmlspecialchars($post['contentImg']); ?>" alt="Post Image" />
                                            <?php endif; ?>
                                            <small>Posted on: <?php echo htmlspecialchars($post['postDate']); ?></small>
                                        </div>
                                    <?php endforeach; ?>
                                <?php else: ?>
