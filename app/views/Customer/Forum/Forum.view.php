...
<html>
    ...
    <div id="Customer">
            ...
            <div class="main-content">
                <div class="container-fluid">
                    <div class="row flex-nowrap">
                        ...
                        <!--Main Content -->
                        <!-- need to retrieve current user's profile by session ID -->
                        <div class="col py-3">
                                        ...
                                        <div class="inner-container">
                                                ...
                                                <div class="post-options">
                                                    ...
                                                    <div class="dropdown-option">
                                                        <button class="report-btn dropdown-item" data-bs-toggle="modal"
                                                                data-bs-target="#reportModal" data-post-id="<?= $postItem['postID'] ?>">
                                            ...
                                            <div class="post-content">
                                                <form class="translateForm">
                                                    <input type="hidden" name="content" value="<?php echo htmlspecialchars($postItem['content'], ENT_QUOTES, 'UTF-8'); ?>">
                                                    ...
                                                    <div class="post-details">
                                                        ...
                                                        <button type="button" class="action-button translate-button" onclick="translateContent(this)">Translate</button>
                                                    </div>
                                                    <p class="translationResult" style="margin-left: 20px; color:limegreen"></p> <!-- Add this to display the result -->
                                                </form>
                                                <script>
                                                ...
                                                <div class="action-container">
                                                            <form id="like-form" action="<?= ROOT ?>/PostInteraction/like" method="POST" style="display: flex; align-items: center;">
                                                                <input type="hidden" name="postID" value="<?php echo $postItem['postID']; ?>">
                                                                ...
                                                                <button type="submit" style="border: none; background: none; cursor: pointer; display: flex; align-items: center;">
                                                                    <div class="action-item" data-post-id="<?php echo htmlspecialchars($postItem['postID'], ENT_QUOTES, 'UTF-8'); ?>">
                                                                        <i class="fa fa-heart-o like-button" id="like-button-<?php echo $postItem['postID']; ?>" onclick="toggleLike(this)"></i>
                                                                        <p class="like-count" id="like-count-<?php echo $postItem['postID']; ?>"><?php echo htmlspecialchars($postItem['likeCount'], ENT_QUOTES, 'UTF-8'); ?></p>
                                                                    </div>
        ...
        <script type="text/javascript">
            ...
            document.querySelectorAll('.action-item').forEach(function (actionItem) {
                actionItem.addEventListener('click', function () {
                    const postID = this.getAttribute('data-post-id');
                    const userID = 4/* Add logic to get the user ID, e.g., from session or hidden input */;

                    // Send AJAX request to like/unlike the post
                    fetch('/path-to-like-endpoint', {
                        method: 'POST',
                        headers: {
                        ...
                        .then(data => {
                            if (data) {
                                ...
                                // Update like count
                                const likeCountElem = actionItem.querySelector('.like-count');
                ...
                fetch(form.action, {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            likeIcon.className = data.isLiked ? 'fa fa-heart' : 'fa fa-heart-o';
