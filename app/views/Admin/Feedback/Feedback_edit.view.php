        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 main-content mt-3">
            ...
            <form class="main-content p-4 mt-3" style="
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="reply" rows="5"><?php echo $data['reply'] ?></textarea>
                </div>

                <div class="mb-3">
                    <label for="coinCompensation" class="form-label">Coin Compensation</label>
                    <input type="number" class="form-control" id="coinCompensation" value="<?= $data['coinCompensation'] ?>"  />
                </div>

                <button type="submit" class="btn btn-primary">Edit</button>
                <a href="Admin_FeedbackView"><button class="btn btn-danger">Back</button></a>
            </form>
        </main>
